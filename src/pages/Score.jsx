              ...
              return (
                <div key={c.id} className="rounded-card border border-line bg-white p-4 shadow-card">
                  <div className="flex items-center gap-3">
                    ...
                    {c.imageUrl ? (
                      <div className="flex h-28 w-28 flex-shrink-0 items-center justify-center overflow-hidden rounded-lg">
                        <img src={c.imageUrl} alt="" className="h-full w-full rounded-lg object-contain p-1" />
                      </div>
                    ) : c.icon ? (
                      <span
                        className="flex h-14 w-14 items-center justify-center rounded-lg bg-plum-50"
                        style={{ fontSize: '2rem' }} 
                      >
                        {c.icon}
                      </span>
